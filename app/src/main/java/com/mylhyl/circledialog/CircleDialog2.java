...
public final class CircleDialog2 {
    private AbsCircleDialog mDialog;

    private CircleDialog2() {
    }
    ...
    public static class Builder {
        ...
        private CircleDialog2 mCircleDialog2;
        ...
        private void onDismiss() {
            if (mCircleParams.dialogFragment != null) {
                mCircleParams.dialogFragment.dismissAllowingStateLoss();
                mActivity = null;
        ...
        public DialogFragment create() {
            if (mCircleDialog2 == null)
                mCircleDialog2 = new CircleDialog2();
            return mCircleDialog2.create(mCircleParams);
        }

        public DialogFragment show() {
            DialogFragment dialogFragment = create();
            mCircleDialog2.show(mActivity);
