...
class TinkerUtil {
    ...
    private static final String TAG = "Tinker.TinkerUtil";

    public static final int ERROR_PATCH_GOOGLE_PLAY_CHANNEL = -20;
    ...
    public static int checkForPatchRecover(long roomSize, int maxMemory) {
        if (TinkerUtil.isGooglePlay()) {
            return TinkerUtil.ERROR_PATCH_GOOGLE_PLAY_CHANNEL;
        }
