...
final class RealReport {
    private static final String TAG = "Tinker.RealReport";
    ...
    public static final int KEY_TRY_APPLY_IN_SERVICE = 73;
    public static final int KEY_TRY_APPLY_NOT_EXIST = 74;
    public static final int KEY_TRY_APPLY_GOOGLE_PLAY = 75;
    ...
    public static final int KEY_LOADED_PACKAGE_CHECK_TINKER_FLAG_NOT_SUPPORT = 358;
    ...
    public static void onTryApplyFail(int errorCode) {
        ...
        switch (errorCode) {
            ...
            case ShareConstants.ERROR_PATCH_INSERVICE:
                reporter.onReport(KEY_TRY_APPLY_IN_SERVICE);
                break;
            ...
            case ShareConstants.ERROR_PATCH_JIT:
                ...
                break;
            case TinkerUtil.ERROR_PATCH_ROM_SPACE:
                reporter.onReport(KEY_TRY_APPLY_ROM_SPACE);
                break;
            case TinkerUtil.ERROR_PATCH_GOOGLE_PLAY_CHANNEL:
                reporter.onReport(KEY_TRY_APPLY_GOOGLE_PLAY);
                break;
            case ShareConstants.ERROR_PATCH_ALREADY_APPLY:
                reporter.onReport(KEY_TRY_APPLY_ALREADY_APPLY);
                break;
            case TinkerUtil.ERROR_PATCH_CRASH_LIMIT:
                reporter.onReport(KEY_TRY_APPLY_CRASH_LIMIT);
                break;
            case TinkerUtil.ERROR_PATCH_MEMORY_LIMIT:
                reporter.onReport(KEY_TRY_APPLY_MEMORY_LIMIT);
                break;
            case TinkerUtil.ERROR_PATCH_CONDITION_NOT_SATISFIED:
    ...
    public static void onLoadPackageCheckFail(int errorCode) {
        ...
        switch (errorCode) {
            ...
            case ShareConstants.ERROR_PACKAGE_CHECK_TINKERFLAG_NOT_SUPPORT:
                reporter.onReport(KEY_LOADED_PACKAGE_CHECK_TINKER_FLAG_NOT_SUPPORT);
                break;
        }
    }
    ...
    public static void onLoadInterpretReport(int type, Throwable e) {
        ...
        switch (type) {
            case ShareConstants.TYPE_INTERPRET_GET_INSTRUCTION_SET_ERROR:
                ...
                reporter.onReport("Tinker Exception:interpret occur exception "
                        + TinkerUtil.getExceptionCauseString(e));
                break;
    ...
    public static void onLoadException(Throwable throwable, int errorCode) {
        ...
        if (!isCheckFail) {
            reporter.onReport("Tinker Exception:load tinker occur exception "
    ...
    public static void onApplyDexOptFail(Throwable throwable) {
        ...
        if (throwable.getMessage().contains(ShareConstants.CHECK_DEX_OAT_EXIST_FAIL)) {
            ...
            reporter.onReport("Tinker Exception:apply tinker occur exception "
                    + TinkerUtil.getExceptionCauseString(throwable));
        }
    }
